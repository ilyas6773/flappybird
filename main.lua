...
-- initialize our last recorder Y value for a gap placement to base other gaps off of
...
function love.update(dt)
    ...
    -- spawn a new PipePir if the timer is past 2 seconds
    ...
    -- modifying the table in-place without explicit key result in skipping the 
    -- next pipe, since all implicit keys (numerical indices) are authomatically shifted
